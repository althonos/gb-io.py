...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/gb-io",
    ...
    "switcher": {
        "json_url": "https://gb-io.readthedocs.io/en/latest/_static/switcher.json",
...
htmlhelp_basename = gb_io.__name__
